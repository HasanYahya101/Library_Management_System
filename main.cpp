...
void returnBook()
{
    ...
    if (late == "yes")
    {
        ...
        cout << "Pay it at you earliest convinience..." << endl
             << endl;
        cout << "Press any key to continue..." << endl;
        _getch();
    }
...
void deleteuserandpass()
{
    ...
    // delete username_user.txt
    remove((username + "_user.txt").c_str());
    cout << endl;
    cout << "---------------------------" << endl;
...
void changepassword()
{
    ...
    // open username_user.txt and replace password
    ofstream fout;
    fout.open((username + "_user.txt").c_str());
